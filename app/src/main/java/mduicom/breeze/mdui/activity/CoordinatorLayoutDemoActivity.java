...
public class CoordinatorLayoutDemoActivity extends AppCompatActivity implements AppBarLayout.OnOffsetChangedListener{
    ...
    FrameLayout title;
    @Bind(R.id.main1_collapsing)
    CollapsingToolbarLayout collapsing;
    @Bind(R.id.main1_appbar)
    AppBarLayout mAppBarLayout;
    @Bind(R.id.main_textview_title)
    TextView mTitle;
    @Bind(R.id.main1_toolbar)
    Toolbar mToolbar;
